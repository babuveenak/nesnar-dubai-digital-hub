...
const Index = () => {
  ...
  const industries = ["Real Estate", "Retail", "Public Sector", "Manufacturing", "Finance"];
  const heroSlides = [{
    image: heroSlide1,
                      ...
                      <div className="absolute inset-0 flex items-center">
                        <div className="container mx-auto px-8 md:px-16">
                          <div className="max-w-3xl">
                            ...
                            {index === 0 && <div className="flex flex-col sm:flex-row gap-4 animate-fade-in">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">Comprehensive technology solutions powered by Oracle, Salesforce and Mobility platforms</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            return <Card key={service.title} className="shadow-card hover:shadow-card-hover transition-all duration-300 overflow-hidden">
                  <div className="h-48 bg-contain bg-center bg-no-repeat border-2 border-border bg-background" style={{
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {industries.map(industry => <Card key={industry} className="shadow-card">
